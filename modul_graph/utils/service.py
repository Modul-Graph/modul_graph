from modul_graph.DTOs import CompetenceScDTO, PflichtmoduleDTO, WpfDTO, ModuleCompetenceDTO
...
from modul_graph.utils.data_access import da_get_semester_to_module_area_for_standard_curriculum
