...
wpf_inf.filled_by_module.connect(software_engineering_it_projektmanagement)
...
wpf_inf_mat.filled_by_module.connect(parallele_programmierung)
wpf_inf_mat.filled_by_module.connect(software_engineering_it_projektmanagement)
