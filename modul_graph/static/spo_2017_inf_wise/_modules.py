...
algorithmen_und_datenstrukturen.cp = 6.0
...
computer_aided_geometric_design.cp = 5.0
...
einführung_in_die_informatik.cp = 8.0
...
einführung_in_digitale_spiele.cp = 5.0
...
ethische_herausforderungen_im_digitalen_zeitalter.cp = 3.0
...
grundlagen_der_bildverarbeitung.cp = 5.0
...
grundlagen_der_cpp_programmierung.cp = 5.0
...
grundlagen_der_theoretischen_informatik.cp = 5.0
...
grundlagen_der_theoretischen_informatik_ii.cp = 5.0
...
grundzüge_der_algorithmischen_geometrie.cp = 5.0
...
introduction_to_deep_learning.cp = 10.0
...
introduction_to_robotics.cp = 5.0
...
introduction_to_simulation.cp = 5.0
...
it_projektmanagement.needs_competence.connect(algorithmen_und_datenstrukturen)
...
parallele_programmierung.cp = 5.0
...
schlüsselkompetenzen_i.name = "Schlüsselkompetenzen I&II"
schlüsselkompetenzen_i.cp = 5.0
...
schlüsselkompetenzen_ii.name = "Schlüsselkompetenzen I&II"
schlüsselkompetenzen_ii.cp = 5.0
...
software_engineering_it_projektmanagement.cp = 5.0
...
software_engineering.cp = 5.0
software_engineering.module_description = "Vermittelt werden sollen hierbei Techniken und Tools, welche die Entwicklung von großen Softwareprojekten zwangsläufig notwendig machen. Dabei wird innerhalb des Semesters der gesamte Entwicklungszyklus vom ersten Requirement über das Softwaredesign bis zur Erstellung der Dokumentation durchgespielt. Die Veranstaltung richtet sich an alle Informatik-Bachelorstudenten."
software_engineering.save()

software_engineering.needs_competence.connect(analysis)
software_engineering.needs_competence.connect(algorithmen_und_datenstrukturen)
software_engineering.needs_competence.connect(betriebssysteme)
software_engineering.needs_competence.connect(numerik)
software_engineering.provides_competence.connect(analysis)
software_engineering.provides_competence.connect(algorithmen_und_datenstrukturen)

softwareprojekt = Module()
softwareprojekt.name = "Softwareprojekt"
softwareprojekt.cp = 6.0
...
technische_informatik_i.cp = 5.0
...
technische_informatik_ii.cp = 5.0
...
trainingsmodul_schlüssel_und_methodenkompetenz = Module()
trainingsmodul_schlüssel_und_methodenkompetenz.name = "Trainingsmodul Schlüssel- und Methodenkompetenz "
trainingsmodul_schlüssel_und_methodenkompetenz.cp = 3.0
trainingsmodul_schlüssel_und_methodenkompetenz.module_description = "Dieses Modul wird durch unterschiedliche Lehrveranstaltungen implementiert. Die Inhalte sind daher angebotsspezifisch."
trainingsmodul_schlüssel_und_methodenkompetenz.save()

trainingsmodul_schlüssel_und_methodenkompetenz.needs_competence.connect(algorithmen_und_datenstrukturen)

usability_und_ästhetik = Module()
usability_und_ästhetik.name = "Usability und Ästhetik"
usability_und_ästhetik.cp = 5.0
...
wahlpflichtfach_fin_schlüssel_und_methodenkompetenz.cp = 5.0
...
wissenschaftliches_seminar.cp = 3.0
