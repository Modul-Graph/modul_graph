from neomodel import StructuredNode, RelationshipTo, ZeroOrMore, IntegerProperty, RelationshipFrom # type: ignore
...
class Semester(StructuredNode):
    ...
    specified_by_standard_curriculum = RelationshipFrom('modul_graph.models.standard_curriculum.StandardCurriculum', 'SPECIFIES', ZeroOrMore)
